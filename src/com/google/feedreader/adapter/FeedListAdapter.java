package com.google.feedreader.adapter;
    ...
    extends BaseAdapter
{
    ...
    public void click( int position )
    {
        ...
        String loadUri = uri.substring(33, uri.length());
        Intent webIntent = new Intent( "android.intent.action.VIEW", Uri.parse( loadUri ) );
