...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "donaid-chat";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "888521470203";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "888521470203.apps.googleusercontent.com";
